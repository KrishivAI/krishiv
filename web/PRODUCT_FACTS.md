...
| Batch SQL | Available | `README.md`, `examples/batch-sql`, `docs/running-examples.md` | Batch SQL is available over registered Arrow/Parquet-style sources. |
...
| Parquet | Preview | `docs/contracts/connectors.md`, examples/batch-sql | Parquet source/sink paths exist; avoid claiming distributed atomic writes. |
