...
<Callout type="info" title="Choose the configuration surface first">
  The tables on this page describe environment-aware APIs and services. CLI
  subcommands have their own parsers, so use their explicit flags unless a
  command documents an environment-variable override.
</Callout>
...
<Cards>
  <Card
    title="Placement"
    description="Select embedded, single-node, or distributed execution intent."
    href="#placement"
  />
  <Card
    title="Durability profiles"
    description="Choose backing services that match the failure boundary you test."
    href="#durability-profiles"
  />
  <Card
    title="State and streaming"
    description="Configure state backends, snapshots, batching, and watermarks."
    href="#state-and-streaming"
  />
  <Card
    title="Authentication and TLS"
    description="Provide separate client and executor credentials."
    href="#authentication-and-tls"
  />
  <Card
    title="Query and executor tuning"
    description="Adjust batching, memory, adaptive execution, and logging."
    href="#query-and-executor-tuning"
  />
  <Card
    title="Parsing and validation"
    description="Use portable Boolean spellings and canonical variable names."
    href="#value-parsing-and-validation"
  />
</Cards>
...
<Cards>
  <Card
    title="CLI reference"
    description="Use the flags parsed by each command and inspect compiled help."
    href="/docs/engine/reference/cli"
  />
  <Card
    title="Execution modes"
    description="Understand how placement and durability intent differ."
    href="/docs/engine/concepts/execution-modes"
  />
  <Card
    title="Security"
    description="Protect coordinator and executor control paths."
    href="/docs/engine/operations/security"
  />
  <Card
    title="Observability"
    description="Inspect health, readiness, metrics, logs, and traces."
    href="/docs/engine/operations/observability"
  />
</Cards>
