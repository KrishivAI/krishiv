...
/// Re-exported from krishiv-sql (task #147): one implementation shared by
/// the engines loops, the distributed executor, and the bench harness.
pub use krishiv_sql::stateless_exec::StatelessBatchExecutor;
