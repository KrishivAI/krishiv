...
`/console` serves a React 19 + TanStack SPA (source in `console/` at the repo
root, same structure and design system as the krishiv-platform console). The
...
Dev loop: `cd console && npm run dev` (proxies to a local coordinator on
