...
#[cfg(feature = "k8s")]
async fn run_k8s_operator() -> Result<(), Box<dyn Error>> {
...
fn main() -> Result<(), Box<dyn Error>> {
    #[cfg(feature = "k8s")]
    {
        // Operator is I/O-bound: kube API watch loops + gRPC dispatch. Cap at 8
        // workers; K8s event throughput never saturates all cores.
