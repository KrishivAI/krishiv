...
def filter(column: ColumnLike, f: Callable) -> Column: ...
...
def aggregate(column: ColumnLike, initialValue: ColumnLike, merge: Callable, finish: Optional[Callable] = None) -> Column: ...
def reduce(column: ColumnLike, initialValue: ColumnLike, merge: Callable, finish: Optional[Callable] = None) -> Column: ...
