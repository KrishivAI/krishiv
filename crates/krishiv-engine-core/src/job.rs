...
pub struct CompiledJob {
    /// Stable job name (becomes the job id at submit time).
    pub name: String,
...
impl CompiledJob {
    ...
    /// carry a query, and have at least one source. Engine-specific checks live
    /// in [`ComputeEngine::validate`](crate::ComputeEngine::validate).
