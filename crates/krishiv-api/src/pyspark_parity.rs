...
pub const PARITY: &[ApiEntry] = &[
    ...
    entry(
        ...
        Supported,
        "rename",
        "rename(existing, new); Spark's silent no-op on a missing column differs (rename validates)",
    ),
    ...
    entry(Column, "between", Supported, "Expr::between", ""),
    entry(Column, "isin", Supported, "Expr::is_in", "varargs or a list"),
    entry(Column, "like", Supported, "Expr::like", ""),
    entry(Column, "rlike", Supported, "regexp_like", "Rust regex dialect"),
    entry(Column, "ilike", Supported, "Expr::ilike", ""),
    entry(Column, "contains", Supported, "Expr::contains", ""),
    entry(Column, "startswith", Supported, "Expr::starts_with", ""),
    entry(Column, "endswith", Supported, "Expr::ends_with", ""),
    entry(Column, "substr", Supported, "Expr::substr", "1-based"),
    entry(
        Column,
        "eqNullSafe",
        Supported,
    ...
    entry(Functions, "when", Supported, "when", "F.when(...).otherwise(...)"),
    entry(
        Functions,
        "coalesce",
        Supported,
