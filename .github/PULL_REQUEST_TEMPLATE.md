...
- [ ] The change stays inside the compute-engine boundary in `docs/architecture/00-overview.md`
...
- [ ] `docs/engineering-log/status.md` was updated for a substantial implementation session
