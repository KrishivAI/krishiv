...
**Measured, and gated: 7 of 44 registered verbatim.** `cargo test -p
...
| suite | verbatim (engine) | of which via a decomposed chain |
|---|---|---|
| TPC-H | **2 / 22** (q1, q6) | 2 (both) |
| NEXMark | **5 / 22** (q0, q10, q14, q21, q22) | 0 (all single-operator) |
